...
import { Transfer as TransferEvent } from "../generated/ScrubPoint/ScrubPoint";
import {
    ScrubPointHolder,
    ScrubPointMint,
    ScrubPointStats,
...
export function handleTransfer(event: TransferEvent): void {
  ...
  if (event.params.from.equals(ZERO_ADDRESS)) {
    ...
    mint.totalSupply = stats.totalSupply;
    ...
    toHolder.balance = prevBalance.plus(value);
    ...
    fromHolder.balance = prevBalance.minus(value);
